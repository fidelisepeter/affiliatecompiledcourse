...
const lightToDarkButton = document.getElementById("switch-theme");
lightToDarkButton?.addEventListener("click", function () {
    
    if (localStorage.getItem("affiliatecompiledcourse-theme-color")) {
      if (localStorage.getItem("affiliatecompiledcourse-theme-color") === "light") {
        document.documentElement.classList.add("is_dark");
        localStorage.setItem("affiliatecompiledcourse-theme-color", "dark");
        lightToDarkButton?.classList.add("dark--mode");
      } else {
        document.documentElement.classList.remove("is_dark");
        localStorage.setItem("affiliatecompiledcourse-theme-color", "light");
